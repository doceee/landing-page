    ...
    <div class="w-full bg-[#F5F5F5]">
        ...
        >
            <div v-for="item in data" :key="item.question" class="text-left">
                ...
                <p class="text-[10px] font-normal">{{ item.answer }}</p>
            </div>
        </div>
    </div>
</template>
